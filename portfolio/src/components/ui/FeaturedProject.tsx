        ...
        >
          ...
          <div className="rounded-sm lg:bg-bg-secondary lg:shadow-lg lg:p-5">
            ...
            >
              ...
              <div className="hidden my-3 font-mono text-xs capitalize lg:block text-accent lg:my-2 lg:mt-3"></div>
              tasks/ achievements
            </div>
            <div className="hidden text-base lg:block lg:text-sm">{tasks}</div>
          </div>
        </div>
